// ==========================================
// Google Sheet Webhook URLs
// ==========================================
// Old references (keeping in case you still need them)
...
// ✅ Your new Google Sheet webhook for subscriber intake
const GOOGLE_SHEET_SUBSCRIBER_URL = "https://script.google.com/macros/s/AKfycbzq_tPZ-YMphIesiamVqrkYXaGOfVFfCkOV8D0PqRrj5VNLZAMghuTYrx3ktdsOKH9I3A/exec";
...
document.getElementById("multiStepForm").addEventListener("submit", async function(event) {
    ...
    try {
        var response = await fetch(GOOGLE_SHEET_SUBSCRIBER_URL, {
            method: "POST",
            body: formData,
            redirect: "follow"
        });
